...
| lp_cre_b | 48.16s (ipm) | 2.11s | 18.66s | 2.7e-06 | 4e-06 |
...
| lp_ken_18 | 25.36s (ipm) | 10.42s | DualInfeasible | 1.5e-08 | 5e-10 |
...
| lp_pilot87 | 36.62s (ipm) | 3.82s | 9.77s | 4.9e-07 | 1e-10 |
...
- Fastest of the three on 5 instances: fit2p (0.11s vs HiGHS 1.24s and
  ...
  truss (23x faster than HiGHS). ken_18 solves in 25s where Clarabel
